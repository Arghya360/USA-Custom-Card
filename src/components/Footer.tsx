      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-red-500">
                CSCS Construction Card UK
              </h2>
            </div>
            <p className="text-gray-300 max-w-md">
              Fast-track your UK driving licenses, CSCS cards, and construction certifications without exams. Secure, government-backed, and delivered within 3-6 working days.
            </p>
            <div className="flex space-x-4 pt-2">
              <a 
                href="https://instagram.com/uk_online_service" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3 text-gray-300">
                <span className="text-blue-500 font-bold">📍</span>
                <span>Based in London - 100% Online</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-green-500/10 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} CSCS Construction Card UK. All rights reserved.
          </p>
